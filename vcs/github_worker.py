...
import constants
from helper import Result, parse_license


def handle_github(dependency: str, result: Result, gh_token: Optional[str]):
    ...
    if rl.core.remaining == 0:
        ...
        time.sleep((rl.core.reset - datetime.datetime.now()).total_seconds())
